...
const Projects = () => {
  return (
   ...
   <h2 className='text-center text-5xl font-bold bg-cyan-950 text-white p-4'><span className='text-cyan-500'>My</span> Projects</h2>
         <div className='flex bg-cyan-950 gap-5 items-center justify-center flex-wrap px-3 py-5'>
        <div className='Projects h-[300px] w-[300px] bg-cyan-500 rounded-lg flex flex-col items-center justify-center gap-5 hover:bg-cyan-600 hover:text-white cursor-pointer hover:scale-105 transition-[1s]'>
